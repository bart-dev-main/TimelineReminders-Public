...
local specIndexOffset = 0 -- In older versions of cata, spec indices start at 0 for GetSpecializationInfoForClassID()
...
for classID = 1, GetNumClasses() do
    ...
    if LRP.isCata and classFile == "DEATHKNIGHT" then
        classIcons[classFile] = "interface\\icons\\spell_deathknight_classicon.blp"
    else
...
local function CollectSpellBookData()
    ...
    for specIndex = 1, GetNumSpecializationsForClassID(playerClassID) do
        local _, specName = GetSpecializationInfoForClassID(playerClassID, specIndex + specIndexOffset) -- These are indexed from 0 on classic for some reason
...
function LRP:InitializeConfig()
    ...
    if GetSpecializationInfoForClassID(1, 0) then
        specIndexOffset = -1
    end
    ...
    for classID = 1, GetNumClasses() do
        ...
        for specIndex = 1, GetNumSpecializationsForClassID(classID) do
            local _, specName, _, specIcon = GetSpecializationInfoForClassID(classID, specIndex + specIndexOffset) -- Indices start at 0 in Cata
    ...
    for classID = 1, GetNumClasses() do
        ...
        for specIndex = 1, GetNumSpecializationsForClassID(classID) do
            local _, specName, _, specIcon = GetSpecializationInfoForClassID(classID, specIndex + specIndexOffset)
    ...
    UIDropDownMenu_SetWidth(ttsVoiceDropdown, 120)
